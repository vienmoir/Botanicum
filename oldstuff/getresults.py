...
sourceImage = cv2.imread("img/redm.jpg", cv2.IMREAD_GRAYSCALE);
...
#    features[0] = ['Unknown',eccentricity,
#            #circularity,
#            solidity, extent, diameter, convexhull, 
...
#    data.columns = ['Type','Eccentricity',
#            #'Circularity',
#            'Solidity','Extent',
#            'Equivalent_diameter','Convex_hull','CircleRatio','Mean','Variance',
#            'Median','Mode','Vertical_symmetry','Horizontal_symmetry',
